...
class StaticRouteConcurrencyTest extends TestCase
{
    ...
    public function test_database_serializes_duplicate_live_destination_creation(): void
    {
        ...
        try {
            ...
            $sql = sprintf("INSERT INTO static_routes (routing_instance_id, asset_id, company_id, destination, route_type, created_at, updated_at) VALUES (%d, %d, %d, '10.10.0.0/24', 'discard', now(), now())", $instance->id, $asset->id, $company->id);
