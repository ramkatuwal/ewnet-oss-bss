...
class NetworkPortSwitchingConfigConcurrencyTest extends TestCase
{
    ...
    public function test_database_serializes_concurrent_config_creation_for_one_port(): void
    {
        $company = Company::factory()->create();
        $asset = Asset::factory()->create(['company_id' => $company->id, 'category' => 'NETWORK']);
        ...
        try {
            ...
            $sql = sprintf("INSERT INTO network_port_switching_configs (network_port_id, company_id, mode, created_at, updated_at) VALUES (%d, %d, 'trunk', now(), now())", $port->id, $company->id);
