...
class RoutingL3InterfaceConcurrencyTest extends TestCase
{
    ...
    public function test_database_serializes_duplicate_physical_port_anchor_creation(): void
    {
        ...
        try {
            ...
            $sql = sprintf("INSERT INTO routing_l3_interfaces (routing_instance_id, asset_id, company_id, name, kind, network_port_id, created_at, updated_at) VALUES (%d, %d, %d, 'p', 'physical', %d, now(), now())", $instance->id, $asset->id, $company->id, $port->id);
