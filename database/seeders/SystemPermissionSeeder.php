...
class SystemPermissionSeeder extends Seeder
{
    public function run(): void
    {
        $permissions = [
            ...
            'fim.fiber-segments.create',
            'fim.fiber-segments.update',
            'fim.fiber-segments.delete',
            ...
            'net.pon-domains.view',
            'net.pon-domains.create',
            'net.pon-domains.delete',
